...
$galleryTitle	= "Chris's Photo Gallery";				// Gallery title
$galleryDir		= "../public/gallery/ubergallery/images";			// Original images directory (No trailing slash!)
$thumbsDir		= "../public/gallery/ubergallery/cache";			// Thumbnails directory (No trailing slash!)
$logFile		= "../public/gallery/ubergallery/log.txt";		// Directory/Name of log file
$thumbSize		= 100;							// Thumbnail width/height in pixels
$imgPerPage		= 0;							// Images per page (0 disables pagination)
$cacheExpire	= 10080;							// Frequency (in minutes) of cache refresh
...
$cacheDir = "../public/gallery/ubergallery/cache";
...
if (file_exists($cacheFile) && time() - $cacheTime < filemtime($cacheFile) && $cacheExpire > 0) {
	...
	for ($x = $imgStart; $x < $imgEnd; $x++) {
		...
		echo "      <a href=\"/gallery/ubergallery/images/$images[$x]\" title=\"$altText\" id=\"img-$x\" rel=\"colorbox\"><img src=\"/gallery/ubergallery/cache/$images[$x]\" alt=\"$altText\"/></a>\r\n";
	}
	echo("    </div>\r\n");
